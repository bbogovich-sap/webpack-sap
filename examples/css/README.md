...
chunk (runtime: main) output.js, output.css (main) 509 bytes (javascript) 14.6 KiB (asset) 42 bytes (asset-url) 454 bytes (css) 42 bytes (css-import) 8.64 KiB (runtime) [entry] [rendered]
  > ./example.js main
