...
asset output.js 6.65 KiB [emitted] (name: main)
...
chunk (runtime: main) output.js (main) 457 bytes (javascript) 16.5 KiB (asset) 448 bytes (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 448 bytes 3 modules
